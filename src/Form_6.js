...
const Form_1 = () => {
    ...
    const [selectedRadio, setSelectedRadio] = useState("classid");
                ...
                <div className='cover'>
                    <div className='row'>
                        ...
                        <div className='col-md-6 right_form_1'>
                            <div className='my-5'>
                                <h1 className='text-center' >Login with password </h1>
                            ...
                            <form >
                                <div>
                                    <label className='radio_2 px-5'>
                                        <input type="radio"  className='red-radio'  value="classid" checked={selectedRadio === "classid"} onChange={handleRadioChange} />
                                        Class ID
                                    </label>
                                ...
                                {/* <div>
                                    ...
                                    <input type="text" value={inputValue} onChange={handleInputChange} disabled={!selectedRadio} style={{ borderColor: isValid ? "red" : "" }} class="input_1 " />
                                </div> */}
                                <form>
                                    <div class="mb-3">
                                        <label for="text" class="form-label"></label>
                                        <input type="text" class="form-control text-center" placeholder='ID' id="text" aria-describedby="text" />
                                        {/* <div id="emailHelp" class="form-text">password must be use @ </div> */}
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label"> </label>
                                        <input type="password" class="form-control text-center" placeholder='password' id="exampleInputPassword1" />
                                    </div>

                                    <div>
                                    {/* <button disabled={!isValid} onClick={handleSubmit} class="btn btn-secondary btn-lg btn_1 mx-auto" style={{ background: isValid ? "black" : "#CECECE" }}>
                                      Login
                                    </button> */}
                                    <button   class="btn btn-secondary btn-lg btn_4 mx-auto" >
                                      Login
                                    </button>
                                </div>
                                </form>

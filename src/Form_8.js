                ...
                <div className='cover'>
                    <div className='row'>
                        ...
                        <div className='pass_update '>
                            <form>
                            <a href="form_7"><FaLongArrowAltLeft className="arrow_2" style={{color: "black"}}/></a> 
                            {/* <img src={img9} alt="" class="img-fluid lock_1" /> */}
                                ...
                                <button type="submit" onClick={handleSubmit} class="btn btn-secondary btn-lg btn_4" >Forgot  Password</button>
